...
function UIDSUpload() {
	...
	UIDSUpload.prototype.getStyleSheetContent = function(){
	  ...
	  styleText += "    background: url('/eXoSkin/skin/images/themes/default/commons/skin/DocumentSelector/fileshareUploadDefault.png') no-repeat 3px center;}";
	  ...
	  styleText += "    background: url('/eXoSkin/skin/images/themes/default/commons/skin/DocumentSelector/fileshareUploadPrimary.png') no-repeat 3px center;}";
	  return styleText;
	}

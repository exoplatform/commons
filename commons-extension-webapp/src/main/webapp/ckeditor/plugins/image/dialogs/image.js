						...
						children: [ {
							...
							},
							{
								...
								onClick: function(){
                                                                       ...
                                                                       window.open(encodeURIComponent('/eXoWCMResources/eXoPlugins/content/content.html?insertContentType=Image&subPath='+subPath+'&nodePath=' + nodePath + '&viewType=thumbnail&components=' + previewImageId + '&currentInstance=' + editor.name, 'WCMGadgetSelector', 'width=1024,height=600'));

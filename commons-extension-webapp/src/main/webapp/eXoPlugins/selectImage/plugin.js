...
( function() {
  ...
  CKEDITOR.plugins.add( 'selectImage', {
    ...
    requires: 'widget,dialog,uploadimage,notificationaggregator,autogrow',
    icons: 'selectImage',
    hidpi: false,
    ...
    init: function( editor ) {
      ...
      // Register the widget.
      editor.widgets.add( 'selectImage', image );

      // Add toolbar button for this plugin.
      editor.ui.addButton && editor.ui.addButton( 'selectImage', {
        label: editor.lang.selectImage.insertImage,
        command: 'selectImage',
        toolbar: 'insert,10'
      } );
      ...
      CKEDITOR.dialog.add( 'selectImage', this.path + 'dialogs/selectImage.js' );
    },
  ...
  function widgetDef( editor ) {
    ...
    return {
      ...
      init: function() {
        var helpers = CKEDITOR.plugins.selectImage,
        ...
        hasCaption: function( shift, oldValue, newValue ) {
          ...
          if ( newValue ) {
            ...
            var figure = CKEDITOR.dom.element.createFromHtml( templateBlock.output( {
              ...
              captionPlaceholder: editor.lang.selectImage.captionPlaceholder
            } ), doc );
        ...
        link: function( shift, oldValue, newValue ) {
          if ( shift.changed.link ) {
            ...
            if ( !newValue )
              ...
              var attributes = CKEDITOR.plugins.selectImage.getLinkAttributesGetter()( editor, newValue );
  ...
  function setupResizer( widget ) {
    ...
    resizer.setAttribute( 'title', editor.lang.selectImage.resizer );

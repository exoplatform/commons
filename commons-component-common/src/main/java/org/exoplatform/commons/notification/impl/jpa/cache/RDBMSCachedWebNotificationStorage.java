...
import org.exoplatform.commons.notification.impl.service.storage.cache.*;
...
public class RDBMSCachedWebNotificationStorage implements WebNotificationStorage {
  private static final Log LOG = ExoLogger.getLogger(RDBMSCachedWebNotificationStorage.class);
  //
  ...
  private final JPAWebNotificationStorage storage;

  public RDBMSCachedWebNotificationStorage(JPAWebNotificationStorage storage, CacheService cacheService) {

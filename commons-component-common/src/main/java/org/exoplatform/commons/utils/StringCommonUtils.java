...
public class StringCommonUtils {
  ...
  private static final Pattern SCRIPT_TAG_PATTERN = Pattern.compile("(<(/|)?[ ]*(script|img|a|iframe|object|embed)>|<(a|img|iframe|object|embed)|((on|background|src|expression).*(\"|'))|((javascript).*(;)))",
